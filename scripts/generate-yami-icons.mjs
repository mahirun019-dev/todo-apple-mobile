...
await writeFile(new URL('../public/yami-wordmark-v5.svg', import.meta.url), wordmarkSvg);
await writeFile(new URL('../public/yami-app-icon-v2.svg', import.meta.url), appSvg);
await writeFile(new URL('../public/yami-favicon-v5.svg', import.meta.url), faviconSvg);
await writeFile(new URL('../public/yami-mask-icon-v5.svg', import.meta.url), maskSvg);
await copyFile(new URL('../public/yami-favicon-v2.ico', import.meta.url), new URL('../public/yami-favicon-v5.ico', import.meta.url));
await copyFile(new URL('../public/yami-favicon-32-v2.png', import.meta.url), new URL('../public/yami-favicon-32-v5.png', import.meta.url));
await copyFile(new URL('../public/yami-favicon-v2.ico', import.meta.url), new URL('../public/favicon.ico', import.meta.url));
await copyFile(new URL('../public/yami-app-icon-180-v3.png', import.meta.url), new URL('../public/yami-app-icon-180-v4.png', import.meta.url));
await copyFile(new URL('../public/yami-app-icon-192-v3.png', import.meta.url), new URL('../public/yami-app-icon-192-v4.png', import.meta.url));
await copyFile(new URL('../public/yami-app-icon-512-v3.png', import.meta.url), new URL('../public/yami-app-icon-512-v4.png', import.meta.url));
await copyFile(new URL('../public/yami-app-icon-maskable-512-v3.png', import.meta.url), new URL('../public/yami-app-icon-maskable-512-v4.png', import.meta.url));
