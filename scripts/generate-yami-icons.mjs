...
await writeFile(new URL('../public/yami-wordmark-v3.svg', import.meta.url), wordmarkSvg);
...
await copyFile(new URL('../public/yami-favicon-v2.ico', import.meta.url), new URL('../public/yami-favicon-v3.ico', import.meta.url));
await copyFile(new URL('../public/yami-favicon-32-v2.png', import.meta.url), new URL('../public/yami-favicon-32-v3.png', import.meta.url));
