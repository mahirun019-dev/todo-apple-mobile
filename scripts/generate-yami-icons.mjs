...
await writeFile(new URL('../public/yami-favicon-v4.svg', import.meta.url), faviconSvg);
await writeFile(new URL('../public/yami-mask-icon-v4.svg', import.meta.url), maskSvg);
...
await copyFile(new URL('../public/yami-favicon-v2.ico', import.meta.url), new URL('../public/yami-favicon-v4.ico', import.meta.url));
await copyFile(new URL('../public/yami-favicon-32-v2.png', import.meta.url), new URL('../public/yami-favicon-32-v4.png', import.meta.url));
await copyFile(new URL('../public/yami-app-icon-180-v2.png', import.meta.url), new URL('../public/yami-app-icon-180-v3.png', import.meta.url));
await copyFile(new URL('../public/yami-app-icon-192-v2.png', import.meta.url), new URL('../public/yami-app-icon-192-v3.png', import.meta.url));
await copyFile(new URL('../public/yami-app-icon-512-v2.png', import.meta.url), new URL('../public/yami-app-icon-512-v3.png', import.meta.url));
await copyFile(new URL('../public/yami-app-icon-maskable-512-v2.png', import.meta.url), new URL('../public/yami-app-icon-maskable-512-v3.png', import.meta.url));
