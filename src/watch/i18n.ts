const ja = {
  ...
  mynavi: "マイナビ", official: "公式採用ページ", other: "その他", active: "監視中", checking: "要確認", error: "取得エラー", paused: "停止中", lastCheck: "最終確認", lastSuccess: "最終成功", unchecked: "未確認",
  ...
  before: "変更前", after: "変更後", detected: "検出日時", changes: "変更内容", sourcePage: "監視先", viewCompany: "企業を見る", openSource: "採用ページを開く", all: "すべて", unread: "未読", markAllRead: "すべて既読にする", noUpdates: "新しい企業アップデートはありません", today: "今日", yesterday: "昨日", goToSettings: "設定を開く", duplicate: "同じURLはすでに登録されています。", invalid: "公開されている http / https URLを入力してください。"
} as const;
const zh: { [K in keyof typeof ja]: string } = {
  ...
  mynavi: "Mynavi", official: "官方招聘页面", other: "其他", active: "监控中", checking: "需要确认", error: "获取错误", paused: "已暂停", lastCheck: "最后检查", lastSuccess: "最后成功", unchecked: "未确认",
  ...
  before: "变更前", after: "变更后", detected: "检测时间", changes: "变更内容", sourcePage: "监控来源", viewCompany: "查看企业", openSource: "打开招聘页面", all: "全部", unread: "未读", markAllRead: "全部标为已读", noUpdates: "暂无新的企业更新", today: "今天", yesterday: "昨天", goToSettings: "打开设置", duplicate: "该公司已登记相同网址。", invalid: "请输入公开可访问的 http / https 网址。"
};
