const ja = {
  ...
  before: "変更前", after: "変更後", detected: "検出", all: "すべて", unread: "未読", markAllRead: "すべて既読にする", noUpdates: "新しい企業アップデートはありません", today: "今日", yesterday: "昨日", goToSettings: "設定を開く", duplicate: "同じURLはすでに登録されています。", invalid: "公開されている http / https URLを入力してください。"
} as const;
const zh: { [K in keyof typeof ja]: string } = {
  ...
  before: "变更前", after: "变更后", detected: "检测时间", all: "全部", unread: "未读", markAllRead: "全部标为已读", noUpdates: "暂无新的企业更新", today: "今天", yesterday: "昨天", goToSettings: "打开设置", duplicate: "该公司已登记相同网址。", invalid: "请输入公开可访问的 http / https 网址。"
};
